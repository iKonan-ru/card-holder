...
export const ERROR_FAILED_TO_GET_CARDS = 'Не удалось получить карты';
export const ERROR_FAILED_TO_CLEAR_CARDS = 'Не удалось очистить карты';
...
export const ERROR_FAILED_TO_IMPORT_CARD_TYPES =
  'Не удалось импортировать типы карт';
...
export const ERROR_FAILED_TO_IMPORT_OWNERS =
  'Не удалось импортировать владельцев';
